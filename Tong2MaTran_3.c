...
int main() {
	...
	#pragma omp parallel private(i, id, idh, idc, sidh, sidc, eidh, eidc)	//các lệnh dưới đây cùng nhau chạy trong từng luồng riêng rẽ nhau, số luồng đã đc set ở trên
	//neu cho Nidh, Nidc vao trong thi ko the chay dc!
	{
